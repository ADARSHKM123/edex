...
exports.deleteCartItem = exports.deleteAllCart = exports.addtoCart = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://localhost:3000/api/v1/user/".concat(productId, "/cart")
            });

          case 3:
            res = _context.sent;
            if (res.data.status == 'success') setTimeout(function () {
              (0, _alert.Showalert)('success', 'Added Sucessfully!');
            }, 1000);
            location.reload('http://localhost:3000/api/v1/user/');
            _context.next = 11;
            break;
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.Showalert)('error', 'Error Try again', _context.t0);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://localhost:3000/api/v1/mycart/deleteCartItem/".concat(id)
            });

          case 3:
            res = _context2.sent;
            if (res.data.status == 'success') (0, _alert.Showalert)('success', 'Deleted Successfully');
...
var deleteAllCart = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(cartId) {
    var deleted;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:3000/api/v1/mycart/deleteCart/".concat(cartId)
            });
  ...
  return function deleteAllCart(_x3) {
...
var stripe = Stripe('pk_test_51Ki0l3SAJq8NpmmnqGpKVFpjKeA77QIj9tMzhRTu7qUgOoPX891r5KERrXS2Eg63hMYcAFZWunxvx717O1YXPCZS00BxfbxzbR');

var checkout = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cartId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/booking/checkout-session/".concat(cartId));
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"admin-addproduct.js":[function(require,module,exports) {
"use strict";
...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productData) {
    var successData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (successData.data.status === 'success') {
              (0, _alert.Showalert)('success', 'Added successfully!'); //   window.setTimeout(()=>{
              //       location.assign('/');
              //   },1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:3000/api/v1/products/".concat(productid)
            });

          case 3:
            successData = _context2.sent;

            if (successData === 'null') {
              (0, _alert.Showalert)('success', 'Deleted successfully!'); //   window.setTimeout(()=>{
              //       location.assign('/');
              //   },1500);
            }
...
var _adminAddproduct = require("./admin-addproduct");

var loginform = document.querySelector('.form');
var logOutBtn = document.querySelector('.logout');
var addToCart = document.querySelectorAll('.to-cart');
var deleteItem = document.querySelectorAll('.deleting'); //Cart

var CartTotal = document.querySelectorAll('.total-each');
...
if (addToCart) {
  addToCart.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      (0, _cart.addtoCart)(btn.dataset.id);
    });
  });
}
...
if (deleteItem) {
  deleteItem.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      (0, _cart.deleteCartItem)(btn.dataset.id);
    });
  });
} // if(MyCartHandler){
...
if (productDelete) {
  productDelete.forEach(function (el) {
...
var newOneQty = [];
var newCartTtl = [];
CartPrice.forEach(function (e, i) {
  return newOnePrice[i] = e.textContent;
});
CartQuantity.forEach(function (e, i) {
  return newOneQty[i] = e.textContent;
});
CartTotal.forEach(function (el, i) {
  return el.innerHTML = newOnePrice[i] * newOneQty[i];
}); // Cart Grant Total ////

var initialValue = 0;
CartTotal.forEach(function (e, i) {
  return newCartTtl[i] = +e.textContent;
});
var CartSum = newCartTtl.reduce(getSum, initialValue);

function getSum(total, num) {
  return total + Math.round(num);
}

grantTotal.innerHTML = CartSum; // const initialValue = 0;
...
if (cartBtn) cartBtn.addEventListener('click', function (e) {
  ...
  var cartId = cartBtn.dataset.cart;
  (0, _stripe.checkout)(cartId);
  (0, _cart.deleteAllCart)(cartId);
}); //Account ///////////////////////////////////////////////////////
