    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status == 'success') console.log(productId);
            setTimeout(function () {
...
var cartBtn = document.querySelector('.cart-checkout'); // const MyCartHandler = document.querySelector('.to-mycart');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8160" + '/');
