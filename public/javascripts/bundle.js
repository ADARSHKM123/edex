...
var grantTotal = document.querySelector('.grant-total'); // const MyCartHandler = document.querySelector('.to-mycart');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11418" + '/');
