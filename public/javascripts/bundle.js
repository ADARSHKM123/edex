      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(result); //   if(result.response.data.statusText)
...
var loginform = document.querySelector('.form'); // const header = document.querySelector('.header');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9541" + '/');
