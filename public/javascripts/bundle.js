...
var addToCart = document.querySelectorAll('.addto-cart'); // const header = document.querySelector('.header');
...
if (addToCart) {
  addToCart.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      console.log('clicked');
      (0, _addToCart.addtoCart)(btn.dataset.id);
    });
  });
} //Account ///////////////////////////////////////////////////////
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9817" + '/');
