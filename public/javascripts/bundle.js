...
var CartTotal = document.querySelectorAll('.totalPrice');
var CartPrice = document.querySelectorAll('.price');
var CartQuantity = document.querySelectorAll('.quantity'); // const MyCartHandler = document.querySelector('.to-mycart');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11907" + '/');
